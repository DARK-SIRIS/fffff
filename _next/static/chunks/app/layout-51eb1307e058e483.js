    ...
    [185], {
        ...
        1845: function(e, t, n) {
            ...
            t.GoogleAnalytics = function(e) {
                ...
                return void 0 === o && (o = n), (0, i.useEffect)(() => {
            ...
            t.GoogleTagManager = function(e) {
                ...
                return (0, i.useEffect)(() => {
                    ...
                    children: [(0, a.jsx)(l.default, {
                        ...
                        id: "_next-gtm",
                        "data-ntpc": "GTM",
                        src: "https://www.googletagmanager.com/gtm.js?id=".concat(t).concat(c).concat(r ? "&gtm_auth=".concat(r) : "").concat(s ? "&gtm_preview=".concat(s, "&gtm_cookies_win=x") : "")
                    })]
                })
            }, t.sendGTMEvent = e => {
                if (void 0 === o) {
        ...
        4983: function(e, t, n) {
            ...
            var r = n(5935),
                o = n.n(r),
                a = {};
            for (var i in r) "default" !== i && (a[i] = (function(e) {
                return r[e]
            }).bind(0, i));
            n.d(t, a)
        },
        3313: function(e, t) {
            ...
            n = (e, t) => {
                ...
                }), u.forEach(e => n.insertBefore(e, r)), r.content = (i - l.length + u.length).toString()
        ...
        5935: function(e, t, n) {
            ...
            let r = n(6921),
                ...
                m = e => {
                    ...
                    for (let [n, r] of (a ? (_.innerHTML = a.__html || "", g()) : i ? (_.textContent = "string" == typeof i ? i : Array.isArray(i) ? i.join("") : "", g()) : t && (_.src = t, d.set(t, y)), Object.entries(e))) {
            ...
            function y(e) {
                let {
                    ...
                    appDir: v,
                    nonce: w
                } = (0, l.useContext)(s.HeadManagerContext), b = (0, l.useRef)(!1);
                (0, l.useEffect)(() => {
                    let e = t || n;
                ...
                let x = (0, l.useRef)(!1);
                if ((0, l.useEffect)(() => {
                        !x.current && ("afterInteractive" === u ? m(e) : "lazyOnload" === u && ("complete" === document.readyState ? (0, c.requestIdleCallback)(() => m(e)) : window.addEventListener("load", () => {
                            (0, c.requestIdleCallback)(() => m(e))
                        })), x.current = !0)
                    }, [e, u]), ("beforeInteractive" === u || "worker" === u) && (g ? (_[u] = (_[u] || []).concat([{
                        id: t,
                        src: n,
                        onLoad: r,
                        onReady: o,
                    ...
                    if (p && p.forEach(e => {
                        ...
                        }), "beforeInteractive" === u) return n ? (i.default.preload(n, h.integrity ? {
                        as: "script",
